...
with open('sarsa_lambda=0.1/efficacy.pkl', 'rb') as f: efficacy1 = pickle.loads(f.read())
with open('sarsa_lambda=0.1/meanlength.pkl', 'rb') as f: meanlength1 = pickle.loads(f.read())
with open('sarsa_lambda=0.1/meanR.pkl', 'rb') as f: meanR1 = pickle.loads(f.read())
with open('sarsa_lambda=0.2/efficacy.pkl', 'rb') as f: efficacy2 = pickle.loads(f.read())
with open('sarsa_lambda=0.2/meanlength.pkl', 'rb') as f: meanlength2 = pickle.loads(f.read())
with open('sarsa_lambda=0.2/meanR.pkl', 'rb') as f: meanR2 = pickle.loads(f.read())
with open('sarsa_lambda=0.4/efficacy.pkl', 'rb') as f: efficacy3 = pickle.loads(f.read())
with open('sarsa_lambda=0.4/meanlength.pkl', 'rb') as f: meanlength3 = pickle.loads(f.read())
with open('sarsa_lambda=0.4/meanR.pkl', 'rb') as f: meanR3 = pickle.loads(f.read())
...
plt.plot(xA1,yA1,label="SARSA lambda=0.1")
plt.plot(xA2,yA2,label="SARSA lambda=0.2")
plt.plot(xA3,yA3,label="SARSA lambda=0.4")
